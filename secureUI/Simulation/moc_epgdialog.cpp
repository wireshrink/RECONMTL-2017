/****************************************************************************
** Meta object code from reading C++ file 'epgdialog.h'
**
...
#error "The header file 'epgdialog.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 17), // "itemDoubleClicked"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "EPGDialog\0itemDoubleClicked\0"
};
...
void EPGDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->itemDoubleClicked((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    }
}
...
const QMetaObject EPGDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_EPGDialog.data,
