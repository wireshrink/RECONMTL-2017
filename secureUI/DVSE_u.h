...
int SGX_UBRIDGE(SGX_NOCONVENTION, ocall_file_write, (void* handle, size_t offset, size_t datasize, unsigned char* data));
size_t SGX_UBRIDGE(SGX_NOCONVENTION, ocall_file_size, (char* file_name));
